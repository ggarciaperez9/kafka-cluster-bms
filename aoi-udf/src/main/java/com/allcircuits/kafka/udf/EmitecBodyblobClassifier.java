...
@UdfDescription(
        name = "emitec_bodyblob_classify",
        description = "classify Emitec windows using algo_bodyblob AOI's table",
        version = "0.1.0",
        author = "Gabriel Perez"
)
public class EmitecBodyblobClassifier {

    @Udf(description = "Apply classification model to algo_bodyblob table of Emitec")
    public int emitec_bodyblob_classify(
            ...
            @UdfParameter(value = "T_Angle", description = "the value of T_Angle") final double T_Angle,
            ...
            @UdfParameter(value = "R_Shift_Roi", description = "the value of R_Shift_Roi") final String R_Shift_Roi,
            ...
            @UdfParameter(value = "T_AreaRateMax", description = "the value of T_AreaRateMax") final double T_AreaRateMax,
            @UdfParameter(value = "T_ShapeHeight", description = "the value of T_ShapeHeight") final double T_ShapeHeight,
            @UdfParameter(value = "T_ShapeArea", description = "the value of T_ShapeArea") final double T_ShapeArea) throws PredictException, IOException {

        EasyPredictModelWrapper model = new EasyPredictModelWrapper(MojoModel.load("/home/gabriel/Models/PEM_POST_GU74712796CMS/algo_bodyblob/GBM_model_python_1601015708874_101.zip"));
        ...
        row.put("R_Shift_Roi", R_Shift_Roi);
        row.put("R_Area", R_Area);
        row.put("T_AreaRateMin", T_AreaRateMin);
        row.put("T_AreaRateMax", T_AreaRateMax);
        row.put("T_ShapeHeight", T_ShapeHeight);
        row.put("T_ShapeArea", T_ShapeArea);
