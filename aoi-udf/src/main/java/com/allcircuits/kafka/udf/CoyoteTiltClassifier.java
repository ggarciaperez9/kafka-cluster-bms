...
@UdfDescription(
        name = "coyote_tilt_classify",
        description = "classify cCoyote windows using algo_tilt AOI's table",
        version = "0.1.0",
        author = "Gabriel Perez"
)
public class CoyoteTiltClassifier {
    ...
    public int coyote_tilt_classify(
            ...
            @UdfParameter(value = "R_HeightDiffMax", description = "the value of R_HeightDiffMax") final double R_HeightDiffMax) throws PredictException, IOException {

        EasyPredictModelWrapper model = new EasyPredictModelWrapper(MojoModel.load("/home/gabriel/Models/PEM_POST_COY229564254/algo_tilt/GBM_model_python_1600679241174_517.zip"));
